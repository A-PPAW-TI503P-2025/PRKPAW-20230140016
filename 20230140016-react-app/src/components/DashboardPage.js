    ...
    >
      <div className="bg-white p-10 rounded-lg shadow-md text-center">
        ...
        <button
          ...
          className="py-2 px-6 bg-red-500 text-white font-semibold rounded-md shadow-sm hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-offset2 focus:ring-red-500"
        >
          Logout
        </button>
      </div>
